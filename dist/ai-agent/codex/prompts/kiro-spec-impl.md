...
1. Execute the full TDD workflow exactly as described in `.kiro/steering/tdd-policy.md`. Treat that policy as the single source of truth for the RED→GREEN→REFACTOR cycle, triangulation strategy, test naming, and Given/When/Then comment requirements.

2. **VERIFY - Validate Quality**:
